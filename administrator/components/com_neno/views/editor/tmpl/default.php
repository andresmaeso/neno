...
$document->addScript(JUri::root() . '/media/neno/js/editor.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/codemirror.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/addon/fold/xml-fold.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/addon/edit/matchtags.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/mode/css/css.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/mode/javascript/javascript.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/mode/xml/xml.js');
$document->addScript(JUri::root() . '/media/neno/js/codemirror/mode/htmlmixed/htmlmixed.js');
$document->addStyleSheet(JUri::root() . '/media/neno/js/codemirror/codemirror.css');
